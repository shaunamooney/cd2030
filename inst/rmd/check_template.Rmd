---
title: "Countdown Analysis Report"
output: 
  html_document:
    toc: true
    toc_float: true
...
```{r title-block, echo=FALSE}
cat("# Countdown Analysis Report for", params$country, "\n\n")
```
...
tryCatch(plot(penta3_coverage) + cd_report_theme(),
          error = function(e) {
...
tryCatch(plot(penta3_inequality) + cd_report_theme(), 
         error = function(e) {
            clean_message <- cli::ansi_strip(conditionMessage(e))
            plot.new() # Start a blank plot
            text(
...
tryCatch(plot(measles1_inequality) + cd_report_theme(), 
         error = function(e) {
            clean_message <- cli::ansi_strip(conditionMessage(e))
            plot.new() # Start a blank plot
            text(
