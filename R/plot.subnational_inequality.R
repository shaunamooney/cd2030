...
#'
#' @param x A `cd_subnational_inequality` object returned by [analyze_subnational_inequality()].
...
#' @examples
#' \dontrun{
#' data <- analyze_subnational_inequality(.data, "Kenya", level = "district",
#'   indicator = "measles1", denominator = "penta1")
#' plot(data)
#' }
#'
#' @export
plot.cd_subnational_inequality <- function(x, ...) {
